...
#define STRING_CONFIG_H_AUTHOR "(Gerke van Garderen, Ender-3)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.88 } // measure with FilRight PLA Maker Blue
